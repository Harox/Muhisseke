    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BtnAdicionarProdut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final EditText edtNotificarEstoque =  vi.findViewById(R.id.edtNotificarEstoque);
                final EditText edtFornecedor = vi.findViewById(R.id.edtFornecedor);
                final Spinner spnCategoria = vi.findViewById(R.id.spnCategoria);
                final Spinner spnUnidade = vi.findViewById(R.id.spnUnidade);
                ...
                adpCategoria.add("Bebidas não Alcoolicas");
                ...
                final AlertDialog alertDialog =
                        new AlertDialog
                                .Builder(activityListaProdutos.this)
                                .setView(vi)
